...
//
        ...
        //To print all the Product information that has a specific text in it.
        ...
        System.out.println("A particular product outof warranty");
        
        List<Product> prod = service.getOutOfWarrantyProducts(2023);
        for(Product p : prod){
            System.out.println(p);
        }
        
        System.out.println("++++++++++++++++++++++++++++++++++++++++++++++++");
        // To find a product via it's place
        List<Product> produc = service.getProductsWithPlace("Black Drawer");
        for(Product p : produc){
            System.out.println(p);
        }
